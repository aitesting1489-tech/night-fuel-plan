        ...
        <div className="space-y-3">
          <button
            onClick={async () => {
              ...
              else trackEvent("login", { method: "apple" });
            }}
            className="w-full rounded-xl border border-border bg-card py-3 px-4 font-display font-semibold text-sm text-foreground flex items-center justify-center gap-3 hover:bg-primary/5 hover:border-primary/30 active:scale-[0.98] transition-all duration-200"
          >
            <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
              <path d="M17.05 20.28c-.98.95-2.05.88-3.08.4-1.09-.5-2.08-.52-3.23 0-1.44.65-2.2.46-3.06-.4C3.79 16.17 4.36 9.83 8.64 9.58c1.23.06 2.09.7 2.81.73.99-.2 1.94-.78 3-.66 1.28.16 2.24.66 2.88 1.65-2.61 1.56-1.99 5 .87 5.96-.49 1.29-1.13 2.57-2.15 3.02zM12.03 9.5C11.88 7.55 13.47 5.93 15.32 5.8c.27 2.25-2.04 3.94-3.29 3.7z"/>
            </svg>
            Sign in with Apple
          </button>
          ...
          <button
            onClick={async () => {
              ...
              else trackEvent("login", { method: "google" });
            }}
            className="w-full rounded-xl border border-border bg-card py-3 px-4 font-display font-semibold text-sm text-foreground flex items-center justify-center gap-3 hover:bg-primary/5 hover:border-primary/30 active:scale-[0.98] transition-all duration-200"
          >
